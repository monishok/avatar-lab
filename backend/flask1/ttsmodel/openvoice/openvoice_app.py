...
en_ckpt_base = current_app.config['CHECKPOINTS_BASE'] #'checkpoints/base_speakers/EN'
zh_ckpt_base = 'checkpoints/base_speakers/ZH'
ckpt_converter = ckpt_converter = current_app.config['CHECKPOINTS_CONVERTER'] #'checkpoints/converter'
