...
from flask1.ttsmodel.openvoice.text import cleaners
from flask1.ttsmodel.openvoice.text.symbols import symbols
...
def text_to_sequence(text, symbols, cleaner_names):
  ...
  print(clean_text.encode('utf-8', errors='ignore'))
...
from flask1.ttsmodel.openvoice.text.symbols import language_tone_start_map
